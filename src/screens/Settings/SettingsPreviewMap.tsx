 ...
 * camera height and in the map style (and traffic) chosen on the preview,
 * so a slider move shows at once. One (mono) map, turning slowly unless
 * Reduce Motion is on. It's only a picture: touches pass through to the
 * list.
 */
